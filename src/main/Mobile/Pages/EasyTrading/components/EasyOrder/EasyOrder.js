...
const EasyOrder = () => {
    ...
    return (
        <div className={`container card-bg card-border ${classes.container} width-90 column jc-start ai-center`}>
            ...
            <div className={`${classes.header} card-header-bg row jc-between ai-center px-5 py-3 width-100 fs-02`}>
                ...
                <div className={`row jc-center ai-center cursor-pointer hover-text fs-0-9`}>
                    <Link to={Routes.TransactionsHistory} className={`ml-05 hover-text`}>{t("txHistory.title")}</Link>
                    <Icon
            ...
            <div className={`width-100 column jc-between ai-center py-3 ${classes.content}`} >
                <TextInput
                    select={true}
                    ...
                    options={options?.buy.map((o) => {
                            return {
                                value: o,
                                label: <div className={`row jc-start ai-center px-2`}>
                                    <div className={`${classes.avatar}`}
                                         style={{ backgroundImage: `url("${currencies[o]?.icon}")` }}
                                    />
                                    <span className={`mr-4`}>{getCurrencyNameOrAlias(currencies[o], language)}</span>
                                </div>
                            }
                        }
                    )}
