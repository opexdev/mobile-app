...
const OnChainWithdraw = ({gateways}) => {
    ...
    const submitButtonTextHandler = () => {
        if (isLoading) return <span className="flashit">{t('loading')}</span>
    ...
    return (
        <div className={`column jc-start ai-center card-bg card-border height-98 width-95 px-1 py-2`}>
            ...
            <form onSubmit={(e) => sendWithdrawHandler(e)}  className={`width-90 column jc-between height-100`}>

                <div className={`column width-100 my-2`}>
                    <div className={`my-025 row jc-between ai-center`}>
                ...
                <div className="column width-100">
                    <TextInput
                        ...
                        lead={t("DepositWithdrawTx.destAddress")}
